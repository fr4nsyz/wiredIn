...
> Auto-generated on Friday, June 26 2026 at 20:00 UTC
> From 153 articles across 27 security feeds

---

## 🔥 Top Vulnerabilities (with CVEs)
...
| 6 | Synology issues critical fix for MailPlus Server vulnerabili... | Help Net Security | `CVE-2026-13135, CVE-2026-13136` | 32.9 |
...
| 9 | USN-8472-1: containerd vulnerabilities | Ubuntu Security | `CVE-2026-33814, CVE-2026-47262` | 19.4 |
| 10 | USN-8473-1: containerd vulnerabilities | Ubuntu Security | `CVE-2026-33814, CVE-2026-47262` | 19.4 |

---

## 📰 Trending Stories

### 1. New DirtyClone Linux Kernel Flaw Lets Local Users Gain Root via Cloned Packets
...
### 2. First-Ever Exploitation of PTC Windchill Vulnerability Discovered in the Wild
...
### 6. CISA Warns Critical Lantronix EDS5000 Flaw Is Being Actively Exploited
...
### 7. Critical open-source projects get a new security framework
...
### 8. Synology issues critical fix for MailPlus Server vulnerabilities
...
| **CVEs** | `CVE-2026-13135, CVE-2026-13136` |
| **Score** | 32.9 |
| **Link** | [https://www.helpnetsecurity.com/2026/06/26/synology-mailplus-server-vulnerabilities/](https://www.helpnetsecurity.com/2026/06/26/synology-mailplus-server-vulnerabilities/) |

### 9. Ransomware gangs find Europe’s weakest link in third-party suppliers
...
### 10. The Good, the Bad and the Ugly in Cybersecurity – Week 26
...
### 11. Cordyceps CI/CD Flaws Expose 300+ GitHub Repositories to Supply-Chain Attacks

| | |
|---|---|
| **Source** | The Hacker News |
| **When** | 2d |
| **Tags** | exploit, supplychain, ai, vuln, cloud, windows, hacktivism |
| **Score** | 25.2 |
...
| **Source** | The Hacker News |
| **When** | 2d |
| **Tags** | ransomware, ai, malware, vuln, network, windows, hacktivism |
| **Score** | 23.4 |
...
### 15. In Other News: Chinese Mythos-Like AI, Tata Electronics Breach, Snyk Layoffs

| | |
|---|---|
| **Source** | SecurityWeek |
| **When** | 5h |
| **Tags** | supplychain, ai, apt, macos |
| **Score** | 22.5 |
| **Link** | [https://www.securityweek.com/in-other-news-chinese-mythos-like-ai-tata-electronics-breach-snyk-layoffs/](https://www.securityweek.com/in-other-news-chinese-mythos-like-ai-tata-electronics-breach-snyk-layoffs/) |
...
*Generated by [wiredIn](https://github.com/anomalyco/wiredIn) · 153 articles from 27 feeds*